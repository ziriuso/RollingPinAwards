...
The installable addon payload lives under `RollingPinAwards/`. Tests should load runtime files through `tests/TestHarness.lua` helpers instead of assuming runtime files live at the repository root.
