...
- `RollingPinAwards/RollingPinAwards.toc`: keep `## Interface:` aligned with supported WoW clients. For the 1.2.0 release this is `120007, 120005`.
...
git commit -m "chore: prepare 1.2.0 curseforge release"
...
The stable release should have `isPrerelease: false`, a `RollingPinAwards-1.2.0.zip` asset, and a successful CurseForge upload step in the workflow log.
