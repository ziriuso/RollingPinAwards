...
```powershell
gh release view v1.0.0 --json name,tagName,isPrerelease,assets,url
```

The stable release should have `isPrerelease: false`, a `RollingPinAwards-1.0.0.zip` asset, and a successful CurseForge upload step in the workflow log.
