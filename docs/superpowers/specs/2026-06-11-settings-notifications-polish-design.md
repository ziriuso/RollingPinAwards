...
- Settings uses the same stepper pattern as toast duration: `-`, a centered percent value, and `+`. The scale row steps by exact 5% increments and does not render a slider.
